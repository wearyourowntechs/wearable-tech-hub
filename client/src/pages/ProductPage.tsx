  ...
  return (
    <div className="min-h-screen pt-16">
      <div className="container py-8">
        ...
        >
          <span style={{ color: "oklch(0.85 0.18 195)", fontWeight: 600 }}>Affiliate Disclosure:</span> The links on this page are Amazon affiliate links. If you purchase through these links, WearableTech Hub earns a small commission at no extra cost to you. This helps us continue providing free, unbiased reviews.
        </div>
